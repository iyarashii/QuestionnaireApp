...
namespace QuestionnaireApp.Services
{
    ...
    public class ViewToStringRendererService : ViewExecutor
    {
        ...
        public ViewToStringRendererService(
            ...
            : base((Microsoft.Extensions.Options.IOptions<Microsoft.AspNetCore.Mvc.MvcViewOptions>)viewOptions, writerFactory, viewEngine, tempDataFactory, (System.Diagnostics.DiagnosticListener)diagnosticSource, modelMetadataProvider)
        {
            _ActionContextAccessor = actionContextAccessor;
            _TempDataProvider = tempDataProvider;
        }

        public async Task<string> RenderViewToStringAsync(string viewName, IModel model)
        {
